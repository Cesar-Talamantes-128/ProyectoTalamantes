                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Busca lo que necesitas...',
                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async {
                                    await launchURL(
                                        'https://hagalo.mx/2799-electricidad-e-iluminacion');
                                  },
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                    child: Image.network(
                                      'https://github.com/Cesar-Talamantes-128/HagaloTalamantes6J/blob/main/assets/IMG/CablesH.png?raw=true',
                                      width: double.infinity,
                                      height: 115,
                                      fit: BoxFit.cover,
                                    ),
                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async {
                                    await launchURL(
                                        'https://hagalo.mx/2899-pinturas');
                                  },
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                    child: Image.network(
                                      'https://github.com/Cesar-Talamantes-128/HagaloTalamantes6J/blob/main/assets/IMG/PinturasH.png?raw=true',
                                      width: double.infinity,
                                      height: 115,
                                      fit: BoxFit.cover,
                                    ),
                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async {
                                    await launchURL(
                                        'https://hagalo.mx/tinacos/2714-tinaco-rotoplas-1100l-con-accesorios.html');
                                  },
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                    child: Image.network(
                                      'https://github.com/Cesar-Talamantes-128/HagaloTalamantes6J/blob/main/assets/IMG/rotoplasH.png?raw=true',
                                      width: double.infinity,
                                      height: 115,
                                      fit: BoxFit.cover,
                                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(10),
                                child: Image.network(
                                  'https://github.com/Cesar-Talamantes-128/HagaloImg/blob/main/Taladro.png?raw=true',
                                  width: double.infinity,
                                  height: 115,
                            ...
                            child: Column(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: Image.network(
                                    'https://github.com/Cesar-Talamantes-128/HagaloImg/blob/main/Sacate.png?raw=true',
                                    width: double.infinity,
                                    height: 115,
                                    fit: BoxFit.cover,
                                  ),
